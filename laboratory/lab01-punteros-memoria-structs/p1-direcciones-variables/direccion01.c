...
int main() {
    ...
    donde cada byte almacena 8 bits de información y es una direccion de memoria. 
    ...
    Una variable es un espacio o una posicion, localizada en la memoria de la computadora capaz de almacenar un valor/contenido. 
    Toda variable tiene un nombre, un tipo de dato, un valor/contenido y una direccion de memoria. 
    ...
    El operador & antes de la variable devuelve la direccion de memoria de la misma, esa direccion es 
    del primer byte de la secuencia de bytes ocupada por la variable.
    La funcion sizeof devuelve el numero de bytes para un determinado tipo de dato.     
    */   
